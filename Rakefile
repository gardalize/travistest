...
task :test do
  ...
  puts "SPINNAKER_PROPERTY_DEV_BASEURL=http://dev.myapp.com"
  puts "SPINNAKER_PROPERTY_PRE_BASEURL=http://pre.myapp.com"
  puts "SPINNAKER_PROPERTY_PROD_BASEURL=http://www.myapp.com"
  puts "done"
end
